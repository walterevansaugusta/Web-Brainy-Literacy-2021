...
import { ChimeraZooComponent } from './pages/chimera-zoo/chimera-zoo.component';
import { PinfoldComponent } from './pages/pinfold/pinfold.component';
...
const routes: Routes = [
  ...
  { path: 'chimera-zoo', component: ChimeraZooComponent },
  { path: 'pinfold', component: PinfoldComponent },
